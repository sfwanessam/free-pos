    ...
    <AuthenticatedLayout>
            ...
            <div class="w-full mb-1">
                ...
                <div
                    ...
                    <Link :href="route('catalog.categories.create')"
                        class="text-white bg-violet-800 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-violet-800 focus:outline-none dark:focus:ring-primary-800">
                    Add new product
                    </Link>
                </div>
            </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td
                                        ...
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">.category
                                        </div>
                                    </td>
                                    <td
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button"
                                            class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-violet-800 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-violet-800 dark:focus:ring-primary-800">
        ...
        <div
            ...
            <div class="flex items-center space-x-3">
                <a href="#"
                    class="inline-flex items-center justify-center flex-1 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-violet-800 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-violet-800 dark:focus:ring-primary-800">
