...
const form = useForm({
    ...
    phone_number: props.contact.phone_number,
    fax_number: props.contact.fax_number,
    address: props.contact.address,
    note: props.contact.note,
    sales_person_name: props.contact.sales_person_name,
    sales_person_email: props.contact.sales_person_email,
    sales_person_mobile_number: props.contact.sales_person_mobile_number,
    sales_person_note: props.contact.sales_person_note,
    purchase_person_name: props.contact.purchase_person_name,
    purchase_person_email: props.contact.purchase_person_email,
    purchase_person_mobile_number: props.contact.purchase_person_mobile_number,
    purchase_person_note: props.contact.purchase_person_note,
    default_on_sales: props.contact.default_on_sales,
    default_on_purchases: props.contact.default_on_purchases,
    _method: 'put'
});
                ...
                <div class="mb-4">
                    <nav class="flex mb-5" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                            ...
                            <POSBreadcrumbItem :label="$t('contacts.edit_contact')" />
                        </ol>
                    </nav>
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">{{
                        $t('contacts.edit_contact') }}</h1>
                </div>
